...
const pPageNumber = document.querySelector('.question-page');
const questions = quizData.map(data => new Question(data.question, data.answer, data.options));
const cards = Array.from(document.querySelectorAll('.card'));
const pEstatistics = document.querySelector('.estadisticas');
const nSuccess = document.querySelector('.nSuccess');
const nFail = document.querySelector('.nFail');
