...
let defaultMeses: string = "numero fuera de rango 1 - 12";
const resultadoMes: string = mesesDelAnyo[numeroMes] || defaultMeses;
...
console.log(
  `tipo de dato inicial: ${typeof numeroString} , tipo de dato final ${typeof numeroNumber}`
);
